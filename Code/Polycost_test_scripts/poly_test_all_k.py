...
def work(in_file):
    ...
    out_path = "C://Users/Markus/master-markus/Code/data/synthetic/polytime_cost/all_k_output_poly.txt"
    
    sp.call(["javaw","-jar", "C://Users/Markus/master-markus/Code/algorithm/TCSG_poly.jar", in_path, out_path])
    return 0
