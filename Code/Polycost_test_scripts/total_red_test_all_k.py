...
def work(in_file):
    ...
    out_path = "C://Users/Markus/master-markus/Code/data/synthetic/polytime_cost/all_k_output_only_total_red.txt"
    
    sp.call(["javaw","-jar", "C://Users/Markus/master-markus/Code/algorithm/TCSG_only_total_red.jar", in_path, out_path, "1", "2", "300000"])
    return 0
