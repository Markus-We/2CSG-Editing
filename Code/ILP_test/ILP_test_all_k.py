...
def work(in_file):
    ...
    in_path = "../data/synthetic/polytime_cost/all_k/" + in_file

    out_path = "../data/synthetic/polytime_cost/all_k_output_ILP.txt"
...
if __name__ == '__main__':
    files = []
    with open("../data/synthetic/polytime_cost/all_k/filenames.txt", encoding='utf-8', newline='\r\n') as f:
