...
def work(in_file):
    ...
    in_path = "../data/synthetic/polytime_cost/realworld/realworld/" + in_file

    out_path = "../data/synthetic/polytime_cost/real_world_output_ILP.txt"
...
if __name__ == '__main__':
    files = []
    with open("../data/synthetic/polytime_cost/realworld/realworld/filenames.txt", encoding='utf-8', newline='\r\n') as f:
