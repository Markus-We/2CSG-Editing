...
def work(in_file):
    ...
    in_path = "C://Users/Markus/master-markus/Code/data/synthetic/np_cost/all_k/" + in_file
    
    out_path = "C://Users/Markus/master-markus/Code/data/synthetic/np_cost/all_k_output_only_total_red.txt"
    
    sp.call(["javaw","-jar", "C://Users/Markus/master-markus/Code/algorithm/TCSG_only_total_red.jar", in_path, out_path, "1", "1", "300000"])
    return 0
 
if __name__ == '__main__':
    files = []
    with open("C://Users/Markus/master-markus/Code/data/synthetic/np_cost/all_k/filenames.txt", encoding='utf-8', newline='\r\n') as f:
